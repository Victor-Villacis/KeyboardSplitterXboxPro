...
//! `docs/research/design-risk-review.md` §3). Where a comment below cites a
//! `.cs` file, that path is relative to djlastnight's KeyboardSplitterXbox —
//! the C# app ksx replaced, located by `docs/LEGACY-UPSTREAM.md`:
